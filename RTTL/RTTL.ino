...
//char *song = (char*)"GunsAndR:d=4,o=6,b=225:d5,d,a5,g5,g,a5,f_,d5,d,a5,g5,g,a5,f_,a5,e5,d,a5,g,a5,f_,a5,e5,d,a5,g5,g,a5,f_,a5,f_,a5,e5,d,a5,g5,g,a5,f_,a5";
...
void loop(void)
{
  ...
  if(remoteTriggered) {
    if(!songDone) { // Start song
      digitalWrite(13,HIGH); // Light the onboard Blue LED while the song plays
      songDone = true;
      begin_rtttl(song);
    }
    if(!next_rtttl()) { // Play next note
      digitalWrite(13,LOW); // Turn off the onboard Blue LED.
      songDone = false;
